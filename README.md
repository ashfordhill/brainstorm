...
<p align="center">
<img src=".docs/imessage-factcheck.png" alt="iMessage factcheck" width="600" />
</p>
...
Digital privacy is a pipe dream and illusion, give up.
...
<p align="center">
<img src=".docs/imessage-emojifusion.png" alt="iMessage emojifusion" width="600" />
</p>

`@emojifusion` will be an energy-intensive command to do what users have always dreamed of: Fusing your 2 favorite emojis into 1 emoji. Like a snowflake, each fusion will be unique.

<p align="center">
<img src=".docs/imessage-flip.png" alt="iMessage emojifusion" width="600" />
</p>

`@flip` is for users who love a little lighthearted fun in their chats. This commnd will flip the chat messages for all users in the current chat to become upside down! Note that the typing box will still remain right-side up. "Undo it" you say? Not so fast there, cowboy! `@flip` has a 10 minute cooldown. Fun for the whole family!
